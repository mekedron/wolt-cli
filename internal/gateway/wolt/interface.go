...
// CanAuthenticate reports whether the context can make an authenticated
// request now or recover an access token through the refresh endpoint.
func (a AuthContext) CanAuthenticate() bool {
	return a.HasCredentials() || strings.TrimSpace(a.RefreshToken) != ""
}
